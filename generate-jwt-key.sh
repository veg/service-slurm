...
echo "EXTERNAL_JWT_KEY_PATH=/jwt_keys/$OUTPUT_FILE"
echo "JWT_KEY_VOLUME=$FULL_PATH:/jwt_keys/$OUTPUT_FILE:ro"
echo ""
echo "Remember to keep this key secure and backed up!"
